...
1. L’icône de notification comporte un badge indiquant le nombre d’éléments incomplets actuellement attribués. [notifications.](/help/using/notifications.md)
...
1. Le lien de prise en main permet d’accéder au [parcours de documentation d’intégration](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview) pour vous familiariser avec Cloud Manager.
   * Notez que le parcours d’intégration est conçu pour AEM as a Cloud Service et non Cloud Service pour AMS, mais de nombreux concepts sont identiques.
...
* Nombre de [déploiements](/help/using/code-deployment.md)
* Nombre de [problèmes de qualité du code](/help/using/code-quality-testing.md) identifié
* Nombre de versions
...
* Nom du programme
* Type de service : **Experience Manager Cloud** pour [AEM programmes as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/home) ou **Experience Manager** pour les programmes AMS
* [Type de programme](/help/getting-started/program-setup.md): environnement de test ou production
* Statut
...
* Accédez à un [environnement](/help/using/managing-environments.md) du programme
...
La variable **Licence** vous donne un accès rapide au tableau de bord des licences.
...
* [Visionneuses de contenu](/help/using/content-copy.md) - Ensembles de contenu créé à des fins de copie
* [Copie de l’activité de contenu](/help/using/content-copy.md) - Activités de copie de contenu
