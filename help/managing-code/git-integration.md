...
Cette série vidéo suppose une connaissance de base de la gestion Git et du contrôle de code source. Consultez les [ressources supplémentaires ci-dessous](#additional-resources) pour en savoir plus sur Git.
...
Premières étapes pour synchroniser un référentiel Git géré par le client avec le référentiel Git de Cloud Manager.
...
Synchronisez les balises de publication d’un référentiel Git Cloud Manager dans un référentiel Git géré par le client afin de vous donner une idée du code qui a été déployé dans les environnements d’évaluation et de production.
