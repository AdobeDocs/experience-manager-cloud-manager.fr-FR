...
* Les étapes d’exécution de pipeline qui ont expiré indiquent maintenant explicitement ce fait.
...
* Les liens Aperçu, Environnements et Activité sont parfois disponibles sur la page d’entrée de Cloud Manager.
