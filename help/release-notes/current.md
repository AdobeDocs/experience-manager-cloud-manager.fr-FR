...
description: En savoir plus sur la version 2026.1.0 de Cloud Manager dans Adobe Managed Services.
...
# Notes de mise à jour de Cloud Manager 2026.1.0 dans Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Découvrez la version de [!UICONTROL Cloud Manager] 2026.1.0 dans Adobe Managed Services.
...
La date de publication de la version 2026.1.0 de [!UICONTROL Cloud Manager] est le vendredi 22 janvier 2026.
...
Il n’existe aucun correctif de bugs significatif dans la version de janvier 2026 de Cloud Manager on AMS.
