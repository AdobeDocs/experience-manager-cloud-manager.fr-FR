...
La section ci-dessous décrit la version 2018.7.0 de  qui offre la fonctionnalité de *mise à l’échelle automatique*.
...
La date de publication de la version 2018.7.0 de [!UICONTROL Cloud Manager] est le mardi 10 septembre 2018.
...
* La barre latérale de notification [!UICONTROL Experience Cloud] peut ne pas charger les notifications de manière cohérente. Toutefois, les notifications sont visibles dans  et, si elles sont configurées, elles sont toujours envoyées par e-mail.
