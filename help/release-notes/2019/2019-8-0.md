...
La version 2019.8.0 de [!UICONTROL Cloud Manager] prend en charge les modules de contenu créés de manière sélective, améliore les performances des builds et corrige divers bugs mineurs.
