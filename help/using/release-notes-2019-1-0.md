...
* Ajout de la prise en charge des variables d’environnement personnalisées dans l’environnement de génération. Pour plus d’informations, consultez la section [Création d’un projet d’application AEM](create-an-application-project.md).
