...
Cette section décrit ces étapes en détails. Reportez-vous aux sections [Conditions](#terms) et [Autorisations configurables](#configurable-permissions) lorsque vous créez vos propres autorisations personnalisées.

>[!NOTE]
>
>Pour créer des profils et gérer les autorisations pour Cloud Manager, vous devez disposer des droits d’administrateur de produit dans Admin Console.
...
1. Recherchez une instance dont le nom correspond au modèle `*-cloud-manager` et sélectionnez-la pour gérer les utilisateurs et les autorisations.
...
1. Dans Admin Console, cliquez sur le nom du [nouveau profil de produit](#create).
