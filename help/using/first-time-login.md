...
1. Cliquez sur **Configuration du programme** pour définir la description du **Programme** et les indicateurs de performance clés (IPC).
   ...
   >[!NOTE]
   >
   >Consultez [la section Configuration de votre programme](https://helpx.adobe.com/experience-manager/cloud-manager/using/setting-up-program.html) pour effectuer les étapes suivantes.