...
>
>Pour en savoir plus sur Adobe Admin Console, consultez la documentation de [Admin Console](https://helpx.adobe.com/enterprise/using/admin-console.html).
...
Pour plus d’informations sur la mise à niveau de votre instance AEM vers la version 6.4, voir [Mise à niveau vers AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/upgrade.html).
...
*Par exemple*, si un client a [www.myco.com](http://www.myco.com/) et [www.myotherco.com](http://www.myotherco.com,/) comme noms d’hôte de production et stage-myco.adobecqms.net comme nom d’hôte d’étape, une demande de ce type doit répondre de manière appropriée :
...
Reportez-vous à [Utilisation de [!UICONTROL Cloud Manager]](https://helpx.adobe.com/experience-manager/cloud-manager/using/using-cloud-manager.html) pour commencer à utiliser [!UICONTROL Cloud Manager].
